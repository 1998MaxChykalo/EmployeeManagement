...
namespace EmployeeManagement.Infrastructure.Sql.Core
{
    public class AccountManager : IAccountManager
    {
        ...
        public AccountManager(EmployeeManagementDbContext context, UserManager<ApplicationUser> userManager, RoleManager<ApplicationRole> roleManager)
        {
            _context = context;
        ...
        {
            if (await _context.Employee.Where(o => o.UserId == userId).AnyAsync())
                return false;
